...
def control_logic(sim):
	...
	while bb:
		...
		while m2:
			...
			distance_22 = detect_distance_sensor_2(sim)
			print(distance_22,distance_11)
			if (distance_11==0) and (distance_22 >= 0.166 and distance_22 <= 0.1788):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)s17984
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
				sim.setJointTargetVelocity(e,0.7)
		...
		while t3:
			...
			print("--------",diff)
			if diff < 0.016 and diff > 0.0 and distance_3 > 0:
				print("iiiiii")
				t3=0
				# yy=1s
				sim.setJointTargetVelocity(e,0.7)
		...
		while m3:
			...
			if (distance_11==0) and (distance_33 >= 0.160 and distance_33 <= 0.1763):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
		...
		while t4:
			...
			print("--------",diff)
			if diff < 0.008 and diff > -0.01 and distance_3 > 0:
				print("iiiiii")
				t4=0
				# yy=1s
				sim.setJointTargetVelocity(e,0.7)
		...
		while m4:
			...
			distance_33 = detect_distance_sensor_3(sim)
			print(distance_33,distance_11)
			if (distance_11==0) and (distance_33 >= 0.160 and distance_33 <= 0.1862):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
		...
		while t5:
			...
			diff=distance_1 - distance_3
			print("--------",diff)
			if diff < 0.026 and diff > -0.01 and distance_3 > 0:
				print("iiiiii")
				t5=0
				# yy=1s
				sim.setJointTargetVelocity(e,0.7)
		...
		while m5:
			...
			distance_33 = detect_distance_sensor_3(sim)
			print(distance_33,distance_11)
			if (distance_11==0) and (distance_33 >= 0.120 and distance_33 <= 0.20439):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
		...
		while m6:
			...
			distance_22 = detect_distance_sensor_2(sim)
			print(distance_22,distance_11)
			if (distance_11==0) and (distance_22 >= 0.166 and distance_22 <= 0.2268):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
		...
		while t7:
			...
			diff=-diff
			print("--------",diff)
			if (diff < 0.016 and diff > 0.0) and (distance_2 > 0):
				print("iiiiii")
				t7=0
				# yy=1s
				sim.setJointTargetVelocity(r,0.7)
				sim.setJointTargetVelocity(e,-0.7)
				# sim.setJointTargetVelocity(r,)0.407
		while m7:
			distance_11 = detect_distance_sensor_1(sim)
			distance_22 = detect_distance_sensor_2(sim)
			print(distance_22,distance_11)
			if (distance_11==0) and (distance_22 >= 0.166 and distance_22 <= 0.1998):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
		...
		while t8:
			...
			diff= distance_3 - distance_1
			print("--------",diff)
			if diff < 0.0215 and diff > 0.0199 and  distance_3 > 0:
				print("iiiiii")
				t8=0
				# yy=1s
				sim.setJointTargetVelocity(e,0.7)
		...
		while m8:
			...
			distance_33 = detect_distance_sensor_3(sim)
			print(distance_33,distance_11)
			if (distance_11==0) and (distance_33 >= 0.120 and distance_33 <= 0.1765):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
		...
		while t9:
			...
			diff= distance_3 - distance_1
			print("--------",diff)
			if diff < 0.009035 and diff > -0.009035 and  distance_3 > 0:
				print("iiiiii")
				t9=0
				# yy=1s
				sim.setJointTargetVelocity(e,0.7)
		...
		while m9:
			...
			distance_33 = detect_distance_sensor_3(sim)
			print(distance_33,distance_11)
			if (distance_11==0) and (distance_33 >= 0.120 and distance_33 <= 0.188):
				print("@@@@@@@")
				# sim.setJointTargetVelocity(r,0)
				# sim.setJointTargetVelocity(e,0)
				# sim.setJointTargetVelocity(r,2)
